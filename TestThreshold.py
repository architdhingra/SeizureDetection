import numpy as np
import statistics
OutputPathModels=['/home/archit/Downloads/dataset/',
                  '/home/archit/Downloads/dataset/'] #path of folder containing the files of the output of the model in the text phase
